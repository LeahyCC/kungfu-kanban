...
async function buildPrompt(userId: string, config: ManagerConfig, trigger: string, userMessage: string | null) {
  ...
  return [
    ...
    '',
    'Routing guidance: haiku/low for trivial tasks; sonnet/medium for routine work; opus or fable with high+ effort for complex work. Be frugal: runs bill to the human\'s own API key.',
