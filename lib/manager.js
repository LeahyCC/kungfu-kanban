...
async function snapshot() {
  ...
  const rows = state.tasks.map((t) => ({
    ...
    prChecks: t.prChecks
      ? { base: t.prChecks.base, passing: t.prChecks.passing, failing: t.prChecks.failing, pending: t.prChecks.pending, failed: t.prChecks.failed, wrongBase: t.prChecks.wrongBase, conflicting: t.prChecks.conflicting, noCi: t.prChecks.noCi, ciFixAttempts: t.ciFixes || undefined }
      : undefined,
    deps: (t.deps || []).length
      ? t.deps.map((id) => {
          const d = getTask(id);
