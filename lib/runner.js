...
function buildArgs(task, effModel) {
  // `--` before the prompt: the CLI's own parser reads a bare argv value that
  // starts with '-' (a `---` divider, a `- bullet`) as an unknown option and
  // dies. Flags AFTER the prompt still parse fine.
