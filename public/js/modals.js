...
function settingsFormSnapshot() {
  ...
  return JSON.stringify([
    ...
    f.prWatchAutoFix.checked, f.prWatchAutoFixCi.checked, f.prFooter.checked, f.terminal.checked, f.usageBudgetM.value,
  ]);
}
...
export function openSettings() {
  ...
  f.prFooter.checked = state.config.settings.prFooter !== false;
